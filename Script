...
local Window = Library:CreateWindow({
	...
	Title = 'jchub beta | Figures Library',
	Center = true,
	AutoShow = true,
	Resizable = false,
...
local RightGroupBox = Tabs.Main:AddLeftGroupbox('Exploits')
...
local MyButton = LeftGroupBox:AddButton({
	Text = 'Become Figure [ BETA ]',
	Func = function()
		local Camera = workspace.CurrentCamera
        local Head = workspace.FigureSetup.FigureRagdoll.Head
        game:GetService("RunService").RenderStepped:Connect(function()
           Camera.CFrame = Head.CFrame
        end)
		Library:Notify("You Have Become Figure..")
	end,
	DoubleClick = false,
	Tooltip = 'This is the main button'
})

local InstaWin = LeftGroupBox:AddButton({
	Text = 'Insta Win [ BETA ]',
	Func = function()
		local rootPart = game.Players.LocalPlayer.Character.HumanoidRootPart
        rootPart.CFrame = workspace.ElevatorCar.Details.Web.CFrame
		Library:Notify("Teleported you to the end")
	end,
	DoubleClick = false,
	Tooltip = 'This is the main button'
})
...
local MyButton = RightGroupBox:AddButton({
	Text = 'OH HAILL CHARAAAAA',
	Func = function()
        rootPart.CFrame = workspace.Map.Chara.Nook.CFrame
		Library:Notify("You Have Become Figure..")
	end,
	DoubleClick = false,
	Tooltip = 'This is the main button'
...
local WatermarkConnection = game:GetService('RunService').RenderStepped:Connect(function()
	...
	Library:SetWatermark(('jchub v1 | %s fps | %s ms'):format(
		math.floor(FPS),
